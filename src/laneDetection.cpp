#include "laneDetector/lidar_lane_detector.h"
...
void LaneDetector::extractDrivableRegion(const pcl::PointCloud<PointT> cloud, std::vector<VectorT>& drivable_region, pcl::PointCloud<PointT>::Ptr filtered_cloud) {
