...
#include <laneDetector/point_os1.h>
...
private:
	...
	void extractDrivableRegion(const pcl::PointCloud<PointT> cloud, std::vector<VectorT>& drivable_region, pcl::PointCloud<PointT>::Ptr filtered_cloud);
